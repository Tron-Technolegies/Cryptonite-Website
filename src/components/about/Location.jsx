...
const Location = () => {
  return (
    <section className="bg-[#000000] text-white py-20 px-6 md:px-16">
      <div className="max-w-5xl mx-auto border border-[#123456] rounded-xl p-4 md:p-6">
        {/* Google Map */}
      ...
      <div className="text-center mt-8">
        <a
          ...
          className="px-6 py-3 bg-(--primary-color) text-black font-medium rounded-lg hover:bg-white transition"
        >
          View us on Google
        </a>
      </div>
